...
public class Main {
    ...
    private static final String BASE_PATH = "http://54.188.95.240:9988";

    private static final int NUM_OF_TASKS = 500000;

    private static final int NUM_OF_CONSUMER_THREADS = 1000;
