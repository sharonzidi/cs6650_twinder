...
//            System.out.println("handling message with identifier: " + identifier);
            ...
            final MatchesApi matchesApi = message.getMatchesApi();
            final StatsApi statsApi = message.getStatsApi();
            try {
                ...
                matchesApi.matches(swipeDetails.getSwiper());
                statsApi.matchStats(swipeDetails.getSwiper());
